...
const Sidebar = () => {
  ...
  const activeLink =
    "flex items-center gap-5 pl-4 pt-3 pb-2.5 rounded-lg text-grey text-md m-2";
  const normalLink =
  ...
  return (
    <div className="ml-3 h-screen md:overflow-hidden overflow-auto md:hover:overflow pb-10">
      {activeMenu && (
        <>
